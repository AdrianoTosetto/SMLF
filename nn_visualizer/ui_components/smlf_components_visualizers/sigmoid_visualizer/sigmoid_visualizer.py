...
from PyQt5.QtGui import QBrush, QMouseEvent, QPainter, QPen
...
from nn_visualizer.ui_components.smlf_components_visualizers.dense_visualizer.unit_visualizer import VisualizerUnit
...
class SigmoidVisualizer(CanvasDrawable):
    def __init__(self,
