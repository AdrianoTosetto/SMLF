...
from nn_visualizer.ui_components.smlf_components_visualizers.input_visualizer.input_unit_visualizer import InputUnitVisualizer
from nn_visualizer.ui_components.smlf_components_visualizers.layer_layout_data import LayerVisualizerLayoutData


class InputVisualizer(CanvasDrawable):
    ...
    def _build_drawable_units(self):
        ...
        return [InputUnitVisualizer(x, y, self.layout_data) for (x, y) in units_origins]
