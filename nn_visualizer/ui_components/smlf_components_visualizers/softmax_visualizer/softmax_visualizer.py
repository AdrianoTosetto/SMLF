...
from nn_visualizer.ui_components.smlf_components_visualizers.batch_normalization_visualizer.batch_normalization_layout_data import BatchNormalizationVisualizerLayoutData
...
from nn_visualizer.ui_components.smlf_components_visualizers.relu_visualizer.relu_unit_visualizer import ReLUUnitVisualizer
from nn_visualizer.ui_components.smlf_components_visualizers.relu_visualizer.relu_visualizer_layout_data import ReLUVisualizerLayoutData


class SoftmaxVisualizer(CanvasDrawable):
    ...
    def _build_drawable_units(self):
        ...
        return [ReLUUnitVisualizer(x, y, self.layout_data) for (x, y) in units_origins]
