...
class DefaultBatchNormalizationVisualizerLayoutData(LayerVisualizerLayoutData):
    ...
    def __init__(self, units: int, index: int, origin_x: int):
    ...
    def width(self) -> float:
        return DefaultBatchNormalizationVisualizerLayoutData.NODE_RADIUS +\
            2 * DefaultBatchNormalizationVisualizerLayoutData.PADDING_HORIZONTAL
    ...
    def set_origin(self, origin: tuple[float, float]) -> DefaultBatchNormalizationVisualizerLayoutData:
        self.origin = origin
